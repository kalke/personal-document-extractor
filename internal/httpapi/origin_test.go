...
func TestClientIP(t *testing.T) {
	...
	cases := []struct {
		...
		{"xff_ignored_trusted", "10.0.0.1:1234", "198.51.100.7, 10.0.0.1", "", trusted10, "10.0.0.1"},
		{"xri_trusted", "10.0.0.1:1234", "", "198.51.100.8", trusted10, "198.51.100.8"},
		{"xri_over_xff_trusted", "10.0.0.1:1234", "198.51.100.9", "198.51.100.8", trusted10, "198.51.100.8"},
...
func TestRequestOriginHonorsForwardedBrowser(t *testing.T) {
	...
	r.RemoteAddr = "32.197.176.57:443"
